...
expr_suffix : addop term expr_suffix #expr_suffix_addsub
            | #epsilon20;

term : factor term_suffix;

term_suffix : mulop factor term_suffix #term_suffix_muldiv
            | #epsilon21;
...
expr_list : expr expr_list_tail #expr_lists
	  |#epsilon22;

expr_list_tail : ',' expr expr_list_tail  #expr_list_tails
              | #epsilon23;
